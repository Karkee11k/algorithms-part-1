...
/**
  * PercolationStats - performs a series of computation to
  * estimate the percolation threshold, consider the following
  * computational experiment:
  *		• Initialise all sites to be blocked.
  *		• Repeat the following until the system percolates:
  *			- Choose a site uniformly at randomly among the
  *			  blocked sites.
  *			- Open the site.
  *		• The fraction of the site that are opened when the 
  *		   system percolates provides an estimation of the 
  *		   percolation threshold.
  * By repeating this experiment T times and averaging the 
...
public class PercolationStats {
	...
	/**
	  * Returns the sample standard deviation of the percolation
	  * threshold.
	  *
	  * @return {@code stddev} 
	  */	
